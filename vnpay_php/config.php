...
$vnp_TmnCode = "QWWN1CT2"; //Website ID in VNPAY System
$vnp_HashSecret = "FYPDMPTCFKNKXOCIANKORHMJWXOXXHDB"; //Secret key
$vnp_Url = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
$vnp_Returnurl = "http://localhost/shoppers-gh-pages/vnpay_php/vnpay_return.php";
...
values ('$customer_id', '$name_receiver', '$phone_number_receiver', '$address_receiver', '$status', '$total')";
