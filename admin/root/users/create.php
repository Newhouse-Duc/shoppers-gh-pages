                    ...
                    <div class="card-body">
                        <form class="form" action="code.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="password" class="form-control" data-rule-required="true" data-rule-minlength="1" data-msg-required="Please enter password.">
                            </div>
                            <div class="mb-3">
                                <label>phone</label>
                                <input type="text" name="phone" class="form-control" data-rule-required="true" data-rule-minlength="1" data-msg-required="Please enter phone.">
                            </div>
                            <div class="mb-3">
                                <label>address</label>
                                <input type="text" name="address" class="form-control" data-rule-required="true" data-rule-minlength="1" data-msg-required="Please enter address.">
                            </div>
                            <div class="mb-3">
